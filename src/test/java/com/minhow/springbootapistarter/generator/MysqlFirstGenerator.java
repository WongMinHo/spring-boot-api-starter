...
//        gc.setFileOverride(true);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/minhow_first?useUnicode=true&useSSL=false&serverTimezone=Asia/Shanghai&autoReconnect=true&characterEncoding=utf8");
        ...
        pc.setController("web.controller.first");
        pc.setService("service.first");
        pc.setServiceImpl("service.first.impl");
        pc.setMapper("dao.first.mapper");
        pc.setEntity("pojo.entity.first");
        pc.setXml("xml");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/src/main/resources/first-mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
